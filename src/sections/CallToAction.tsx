    ...
    <section className="py-[5rem] md:py-[6rem]">
      <div className="container">
        <motion.div
          ...
          className="border border-white/15 py-[6rem] rounded-xl overflow-hidden relative group"
          style={{
            backgroundPositionY,
        ...
        >
          ...
          <div className="relative ">
            ...
            <p className="text-center text-lg md:text-xl max-w-xs md:max-w-sm mx-auto text-white/70 px-[1rem] mt-[1.25rem]">
